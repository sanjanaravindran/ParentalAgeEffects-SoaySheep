...
# Arrange all plots 
plots_final <- p1_mums_sex/(p3_fd + p2_fd + plot_layout(axis_titles = "collect")) + plot_annotation(tag_levels = 'A')
plots_final

# ggsave("./Figures/Aug24_PAE_Lifespan_Fig1.tiff",  plots_final, dpi=300, height = 8, width= 8)
