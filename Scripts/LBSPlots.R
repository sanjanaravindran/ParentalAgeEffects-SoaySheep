...
plots_final <- (p1_mums_sex + p1_dads_sex + patchwork::plot_layout(guides = "collect", axis_titles = "collect"))/(p3_fd + p2_fd + patchwork::plot_layout(axis_titles = "collect")) + plot_annotation(tag_levels = 'A')
plots_final

ggsave("./Figures/2025June_PAE_LBS_Fig2.tiff",  plots_final, dpi=300, height = 6, width= 8)
